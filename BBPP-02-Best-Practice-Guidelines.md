...
5. Wallet hygiene is not consensus and not a substitute for PQ research, but it is the only lever operators have today: avoid address reuse; know whether a spend path reveals a public key (Taproot key-path does). Details: `research/quantum-physics-barriers.md`.
